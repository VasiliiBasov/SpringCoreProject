...
**Дополнение (28.08.2026):** ученик уточнил — правило «не утечка ответов» касается **прежде всего опросов и мини-экзаменов**, а не только «Идеи на пальцах». «Идея на пальцах» — это объяснение новой темы перед вопросом, там частично можно давать ответы (это и есть объяснение). А вот в **самих вопросах и пояснениях к ним** ответ давать **нельзя** — иначе пропадает смысл проверки знаний.

**Дополнение (28.08.2026):** ученик попросил **обязательно указывать слабые стороны** в профиле, не только сильные. Иначе профиль — это «комплименты», а не рабочий инструмент. Критика нужна для развития.
